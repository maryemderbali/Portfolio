...
export default function Hero() {
  const words = [
   "Software Engineer & AI Enthusiast",
    ...
    "Building SaaS Platforms & Web Apps",
  ];
...
const profile = {
    ...
    skills: [
        ...
        'Git', 'Jenkins', 'Node.js', 'Python'
    ],
    education: [
        'ESPRIT – Software Engineering',
        'IPEIM – Math-Physics Preparatory'
    ],
    languages: ['English C1', 'French C1', 'German A2'],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    hireable: function() {
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Software Engineer 🚀 | Full-Stack Developer 💻 | Building SaaS platforms and innovative web solutions ✨
                </p>
              </div>
