...
const ExperienceSection = () => {
  const experiences = [
    {
      icon: Network,
      title: "End‑of‑Studies Internship – Software Engineer",
      company: "Proxym, Sousse",
      period: "Feb 2025 - Jun 2025",
      description:
        "Developed a multi‑module SaaS platform for library management and reader engagement. Built and secured REST APIs using Spring Boot and Keycloak. Implemented workflows with Flowable BPM. Integrated content‑based recommendation system.",
    },
    {
      icon: Layers,
